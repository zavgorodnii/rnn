...
class TrainSequenceInput(object):
...
class TestSequenceInput(object):
    ...
    def __init__(self,
        ...
        self.batch_size = 1
        self.truncate_at = truncate_at
        self.data = self.gen_data(sequence_len, self.batch_size, truncate_at)
    ...
    def gen_data(self, sequence_len, batch_size, truncate_at):
        """Generates :num_epochs gen_batch() generators.
        ...
        """
        raw_X_Y = self.get_X_Y(sequence_len=sequence_len)
        return self.gen_batch(raw_X_Y, batch_size, truncate_at)
